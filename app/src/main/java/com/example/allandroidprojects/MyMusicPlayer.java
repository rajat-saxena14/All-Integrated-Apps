...
import com.example.allandroidprojects.adapters.AlbumsAdapter;
import com.example.allandroidprojects.adapters.ArtistsAdapter;
import com.example.allandroidprojects.adapters.ColorsAdapter;
import com.example.allandroidprojects.adapters.SongsAdapter;
import com.example.allandroidprojects.loaders.ArtistProvider;
import com.example.allandroidprojects.models.Album;
import com.example.allandroidprojects.models.Artist;
import com.example.allandroidprojects.models.Song;
import com.example.allandroidprojects.playback.EqualizerUtils;
import com.example.allandroidprojects.playback.MusicNotificationManager;
import com.example.allandroidprojects.playback.MusicService;
import com.example.allandroidprojects.playback.PlaybackInfoListener;
import com.example.allandroidprojects.playback.PlayerAdapter;
import com.example.allandroidprojects.slidinguppanel.SlidingUpPanelLayout;
import com.simplecityapps.recyclerview_fastscroll.views.FastScrollRecyclerView;

import java.util.List;

public class MyMusicPlayer extends FragmentActivity implements LoaderManager.LoaderCallbacks<List<Artist>>, SongsAdapter.SongSelectedListener, ColorsAdapter.AccentChangedListener, AlbumsAdapter.AlbumSelectedListener, ArtistsAdapter.ArtistSelectedListener {
    ...
    public void onAccentChanged(int color) {
        ...
        MyMusicPlayerUtils.setThemeAccent(this, color);
    }
    ...
    public void onBackPressed() {
        ...
        if (mSlidingUpPanel.getPanelState() == SlidingUpPanelLayout.PanelState.EXPANDED) {
            ...
            AlertDialog.Builder builder=new AlertDialog.Builder(MyMusicPlayer.this);
            builder.setTitle("ACTION NEEDED").setMessage("Do you want to quit custom music player?").setCancelable(true)  //setConcelable is invisible dialog box user touch activity
    ...
    private void checkReadStoragePermissions() {
        if (MyMusicPlayerUtils.isMarshmallow()) {
    ...
    private void showPermissionRationale() {
        ...
        builder.setTitle("CUSTOM MUSIC PLAYER");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sThemeInverted = MyMusicPlayerUtils.isThemeInverted(this);
        mAccent = MyMusicPlayerUtils.getAccent(this);

        MyMusicPlayerUtils.setTheme(this, sThemeInverted, mAccent);
                ...
                new SeekBar.OnSeekBarChangeListener() {
                    ...
                    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                        ...
                        if (fromUser) {
                            ...
                            mSongPosition.setTextColor(ContextCompat.getColor(MyMusicPlayer.this, mAccent));
                        }
    ...
    public void openEqualizer(View v) {
        if (EqualizerUtils.hasEqualizer(this)) {
            if (checkIsPlayer()) {
                mPlayerAdapter.openEqualizer(MyMusicPlayer.this);
            }
        } else {
    ...
    public void openGitPage(View v) {
        try {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.linkedin.com/in/rajat-saxena14/")));
    ...
    public void switchTheme(View v) {
        ...
        MyMusicPlayerUtils.invertTheme(this);
    }
    ...
    private void updatePlayingInfo(boolean restore, boolean startPlay) {
        ...
        Spanned spanned = MyMusicPlayerUtils.buildSpanned(getString(R.string.playing_song, mSelectedArtist, selectedSong.title));
