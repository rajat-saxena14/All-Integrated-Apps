package com.example.allandroidprojects.adapters;
...
public class SongsAdapter extends RecyclerView.Adapter<SongsAdapter.SimpleViewHolder> {
    ...
    public void onBindViewHolder(@NonNull SimpleViewHolder holder, int position) {
        ...
        Spanned spanned = MyMusicPlayerUtils.buildSpanned(mActivity.getString(R.string.track_title, songTrack, songTitle));
