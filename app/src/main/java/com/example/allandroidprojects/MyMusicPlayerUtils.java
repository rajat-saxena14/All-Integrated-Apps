...
public class MyMusicPlayerUtils {

    private static final String ACCENT_PREF = "com.example.allandroidprojects.pref_accent";
    private static final String ACCENT_VALUE = "com.example.allandroidprojects.pref_accent_value";
    private static final String THEME_PREF = "com.example.allandroidprojects.pref_theme";
    private static final String THEME_VALUE = "com.example.allandroidprojects.pref_theme_value";
